...
// import { LoginPost } from '../../untils/requests/postReq.js/loginPost';
...
export default function SignInPage() {
    ...
    const setUser = ()=>{
        // const postUser = LoginPost(isName, isPassword)
        // postUser.then(res=>res.id == undefined ? '' : setIsUser(res))
        setIsUser('asd')
    }
    ...
    <div className={cl.block}>
      ...
      <div className={cl.rightBlock}>
            <form className={cl.rightContent} id="signIn">
                ...
                <MyInput text={'Email'} isInput={isName} parentForm={'signIn'} setIsInput={setIsName} classInput={cl.nameInput}/>
                ...
                <div className={cl.btnBlock}>
                    {btnActive?
                        ...
                        isUser ?
                        <Link href={'/calendar'} onClick={e=>{dispatch({type:'IS_AUTH_CHANGE', info: {value:true}});setUser()}}>
                            <MyBtnFilled>
                                Sign In 
                            </MyBtnFilled>
                        </Link> : 
                            <MyBtnFilled onClick={e=>setUser()}>
                                Sign In 
                            </MyBtnFilled>
